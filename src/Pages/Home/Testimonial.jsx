...
const Testimonial = () => {
  ...
  useEffect(() => {
    fetch("https://employee-management-server-six.vercel.app/review")
      .then((res) => res.json())
    ...
    <div>
      <div>
        <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
          {review.map((review) => (
            <SwiperSlide className="text-center  items-center" key={review._id}>
              <div className="">
                <svg
              ...
              <Rating
                ...
                readOnly
              />
              <h3 className="font-semibold text-xl mt-4 text-[#16A34A] uppercase">
                {review.name}
              </h3>
            </SwiperSlide>
          ))}
