...
const AddItem = () => {
  ...
  return (
    <div>
      <div className="">
        <h3 className="text-3xl text-center font-semibold text-[#44DA64] uppercase my-4">Add New Services</h3>
      </div>
      ...
      <div>
        <div className="bg-base-200 w-9/12 mx-auto py-8">
          <form className="w-8/12 mx-auto " onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-2 my-4 gap-4 max-w-2xl w-full">
              <div className="form-control ">
                ...
                <select
                  ...
                  className="select   select-bordered max-w-[336px] w-full"
                >
            ...
            <button
              className=" btn hover:bg-[#3BBD5B] bg-[#3BBD5B] text-white"
              type="submit"
            >
              Add Item
